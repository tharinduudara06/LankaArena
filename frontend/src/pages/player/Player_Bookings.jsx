...
import './styles/player_bookings.css';
...
useEffect(()=>{
  ...
  const fetchBookings = async() =>
  {
    try {
      ...
      const res = await axios.get('http://localhost:8080/api/player/get-my-bookings',
...
const handlePayNow = (booking) => {
  ...
  navigate('/player-payment-gateway', { 
    state: { 
      bookingData: booking 
    } 
  });
...
const cancelBooking = async (bookingId) => {
  ...
  try {
    ...
    const res = await axios.put(`http://localhost:8080/api/player/cancel-booking/${bookingId}`,
      {},
      {withCredentials:true}
    )
    ...
    <div className="p-mb-container">
      ...
      <div className="p-mb-main-content">
        <div className="p-mb-page-header">
          ...
          <Link to='/player-new-booking' className="p-mb-action-button">
...
export default Player_Bookings;
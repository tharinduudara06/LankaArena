...
import './styles/groundManager-signup.css'

export default function GroundManagerSignup() {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            const res = await axios.post('http://localhost:8080/gm-reg', {name, email, mobile, password, role, status},
                {
    ...
    return (
        <div>
            ...
            <div className='greg-container'>
                <ToastContainer/>
                <div className="greg-main">
                    <form onSubmit={handleSubmit}>
                        <div className="greg_form-item">
